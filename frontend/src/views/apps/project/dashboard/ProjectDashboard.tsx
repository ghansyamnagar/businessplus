...
const ProjectDashboard = ({ totalTaskStatusData, onDownload, hideDownload }: { totalTaskStatusData?: any, onDownload?: () => void, hideDownload?: boolean }) => {
    // States
                ...
                <Grid container spacing={6} alignItems='center'>
                    <Grid item xs={12} md={5}>
                        <Box sx={{ border: '1px solid', borderColor: 'divider', width: '240px', mx: 'auto' }}>
                            <LegendRow color='#4caf50' icon='circle' label='Closed' />
                            <LegendRow color='#ffe802' icon='triangle' label='Open' />
