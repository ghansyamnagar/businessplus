...
type AddEditFacilityDetailsInfoProps = {
    open: boolean
...
const AddEditFacilityDetailsInfo = ({ open, handleClose, data }: AddEditFacilityDetailsInfoProps) => {
    const {
        control,
        reset,
        handleSubmit,
    ...
    return (
        ...
        >
            <DialogTitle variant='h5' className='flex gap-2 flex-col items-center sm:pbs-8 sm:pbe-6 sm:pli-8'>
                <div className='max-sm:is-[80%] max-sm:text-center'>{data ? 'Edit' : 'Add'} Facility Details</div>
            </DialogTitle>
...
export default AddEditFacilityDetailsInfo
