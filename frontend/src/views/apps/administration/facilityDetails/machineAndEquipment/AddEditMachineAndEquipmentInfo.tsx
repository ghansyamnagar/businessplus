...
import { createMachineRequest, updateMachineRequest } from '@/redux-store/slices/master/master.slice'
import { useDispatch } from 'react-redux'


export type MachineAndEquipmentType = {
    id: number
    name: string
    description: string
    image?: string
...
type AddEditMachineAndEquipmentInfoProps = {
    open: boolean
    handleClose: (refresh: boolean) => void
    data?: MachineAndEquipmentType
}
...
const AddEditMachineAndEquipmentInfo = ({ open, handleClose, data }: AddEditMachineAndEquipmentInfoProps) => {
    const {
        control,
        reset,
        handleSubmit,
            ...
            dispatch(
                createMachineRequest({
                    ...
                    callback: (res: any, err: any) => {
                        ...
                        if (res?.status === 'success') {
                            toast.success(res?.message || 'Machine added successfully')
                            handleDialogClose(true)
                        }
    ...
    return (
        ...
        >
            <DialogTitle variant='h5' className='flex gap-2 flex-col items-center sm:pbs-8 sm:pbe-6 sm:pli-8'>
                <div className='max-sm:is-[80%] max-sm:text-center'>{data ? 'Edit' : 'Add'} Machine & Equipment</div>
            </DialogTitle>
...
export default AddEditMachineAndEquipmentInfo
