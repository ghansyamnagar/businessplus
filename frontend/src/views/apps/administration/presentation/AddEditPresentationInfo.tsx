...
import { createPresentationRequest, updatePresentationRequest } from '@/redux-store/slices/master/master.slice'
...
type AddEditPresentationInfoProps = {
    open: boolean
...
const AddEditPresentationInfo = ({ open, handleClose, data }: AddEditPresentationInfoProps) => {
    const {
        control,
        reset,
        handleSubmit,
    ...
    return (
        ...
        >
            <DialogTitle variant='h5' className='flex gap-2 flex-col items-center sm:pbs-8 sm:pbe-6 sm:pli-8'>
                <div className='max-sm:is-[80%] max-sm:text-center'>{data ? 'Edit' : 'Add'} Presentation</div>
            </DialogTitle>
                ...
                <DialogContent className='overflow-visible pbs-0 sm:pbe-6 sm:pli-8'>
                    ...
                    <Grid container spacing={5}>
                        ...
                        <Grid size={{ xs: 6 }}>
                            ...
                            {/* {imagePreview && (
                                <Box sx={{ ml: 2, position: 'relative', display: 'inline-block' }}>
                                    <img
                                        src={imagePreview}
                                        alt='Preview'
                                        style={{ maxWidth: '100%', maxHeight: '70px', borderRadius: '8px', border: '1px solid #e0e0e0' }}
                                    />
                                    <IconButton
                                        size='small'
...
export default AddEditPresentationInfo
