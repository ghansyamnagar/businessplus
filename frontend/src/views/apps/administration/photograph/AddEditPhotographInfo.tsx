...
type AddEditPhotographInfoProps = {
    open: boolean
...
const AddEditPhotographInfo = ({ open, handleClose, data }: AddEditPhotographInfoProps) => {
    const {
        control,
        reset,
        handleSubmit,
    ...
    const onSubmit: SubmitHandler<FormData> = (formData) => {
        ...
        setTimeout(() => {
            if (data?.id) {
                ...
                toast.success('Photograph added successfully')
            }
    ...
    return (
        ...
        >
            <DialogTitle variant='h5' className='flex gap-2 flex-col items-center sm:pbs-8 sm:pbe-6 sm:pli-8'>
                <div className='max-sm:is-[80%] max-sm:text-center'>{data ? 'Edit' : 'Add'} Photograph</div>
            </DialogTitle>
...
export default AddEditPhotographInfo
