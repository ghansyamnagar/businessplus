...
type AddEditProductServicesInfoProps = {
    open: boolean
    handleClose: (refresh: boolean) => void
    data?: ProductServicesType
}
...
const AddEditProductServicesInfo = ({ open, handleClose, data }: AddEditProductServicesInfoProps) => {
    const {
        control,
        reset,
        handleSubmit,
    ...
    return (
        ...
        >
            <DialogTitle variant='h5' className='flex gap-2 flex-col items-center sm:pbs-8 sm:pbe-6 sm:pli-8'>
                <div className='max-sm:is-[80%] max-sm:text-center'>{data ? 'Edit' : 'Add'} Product & Service</div>
            </DialogTitle>
...
export default AddEditProductServicesInfo
