...
import { createSoftwareRequest, updateSoftwareRequest } from '@/redux-store/slices/master/master.slice'
...
type AddEditSoftwareDevelopmentInfoProps = {
    open: boolean
    handleClose: (refresh: boolean) => void
    data?: SoftwareDevelopmentType
}
...
const AddEditSoftwareDevelopmentInfo = ({ open, handleClose, data }: AddEditSoftwareDevelopmentInfoProps) => {
    const {
        control,
        reset,
        handleSubmit,
                ...
                updateSoftwareRequest({
                    ...
                    callback: (response: any) => {
                        ...
                        if (response?.status === 'success') {
                            toast.success('Software Development updated successfully')
            ...
            dispatch(
                createSoftwareRequest({
                    ...
                    callback: (response: any) => {
                        ...
                        if (response?.status === 'success') {
                            toast.success('Software Development added successfully')
                            handleDialogClose(true)
                        } else {
    ...
    return (
        ...
        >
            <DialogTitle variant='h5' className='flex gap-2 flex-col items-center sm:pbs-8 sm:pbe-6 sm:pli-8'>
                <div className='max-sm:is-[80%] max-sm:text-center'>{data ? 'Edit' : 'Add'} Software Development</div>
            </DialogTitle>
...
export default AddEditSoftwareDevelopmentInfo
