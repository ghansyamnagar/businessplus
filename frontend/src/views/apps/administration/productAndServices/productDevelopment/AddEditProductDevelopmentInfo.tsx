...
import { createProductDevRequest, updateProductDevRequest } from '@/redux-store/slices/master/master.slice'
...
export type ProductDevelopmentType = {
    id: number
    name: string
    description: string
    image?: string
...
type AddEditProductDevelopmentInfoProps = {
    open: boolean
    handleClose: (refresh: boolean) => void
    data?: ProductDevelopmentType
}
...
const AddEditProductDevelopmentInfo = ({ open, handleClose, data }: AddEditProductDevelopmentInfoProps) => {
    const {
        control,
        reset,
        handleSubmit,
                ...
                updateProductDevRequest({
                    ...
                    callback: (response: any) => {
                        ...
                        if (response?.status === 'success') {
                            toast.success('Product Development updated successfully')
            ...
            dispatch(
                createProductDevRequest({
                    ...
                    callback: (response: any) => {
                        ...
                        if (response?.status === 'success') {
                            toast.success('Product Development added successfully')
                            handleDialogClose(true)
                        } else {
    ...
    return (
        ...
        >
            <DialogTitle variant='h5' className='flex gap-2 flex-col items-center sm:pbs-8 sm:pbe-6 sm:pli-8'>
                <div className='max-sm:is-[80%] max-sm:text-center'>{data ? 'Edit' : 'Add'} Product Development</div>
            </DialogTitle>
...
export default AddEditProductDevelopmentInfo
