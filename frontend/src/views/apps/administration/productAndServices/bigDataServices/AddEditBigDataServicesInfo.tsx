...
import { createBigDataRequest, updateBigDataRequest } from '@/redux-store/slices/master/master.slice'
...
export type BigDataServicesType = {
    id: number
    name: string
    description: string
    image?: string
...
type AddEditBigDataServicesInfoProps = {
    open: boolean
    handleClose: (refresh: boolean) => void
    data?: BigDataServicesType
}
...
const AddEditBigDataServicesInfo = ({ open, handleClose, data }: AddEditBigDataServicesInfoProps) => {
    const {
        control,
        reset,
        handleSubmit,
                ...
                updateBigDataRequest({
                    ...
                    callback: (response: any) => {
                        ...
                        if (response?.status === 'success') {
                            toast.success('Big Data Services updated successfully')
            ...
            dispatch(
                createBigDataRequest({
                    ...
                    callback: (response: any) => {
                        ...
                        if (response?.status === 'success') {
                            toast.success('Big Data Services added successfully')
                            handleDialogClose(true)
                        } else {
    ...
    return (
        ...
        >
            <DialogTitle variant='h5' className='flex gap-2 flex-col items-center sm:pbs-8 sm:pbe-6 sm:pli-8'>
                <div className='max-sm:is-[80%] max-sm:text-center'>{data ? 'Edit' : 'Add'} Big Data Services</div>
            </DialogTitle>
...
export default AddEditBigDataServicesInfo
