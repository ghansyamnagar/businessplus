  ...
  return {
    ...
    '& .react-datepicker': {
      ...
      '& .react-datepicker__month-select, & .react-datepicker__year-select': {
        ...
        backgroundImage: `url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='14' height='14' viewBox='0 0 24 24'><path fill='%23666' d='M7 10l5 5 5-5z'/></svg>")`,
...
const AppReactDatepicker = (props: Props) => {
  ...
  return (
    <StyledReactDatePicker {...boxProps}>
      <ReactDatePickerComponent popperPlacement='top-start' popperProps={{
        strategy: 'fixed'
      }} {...rest} />
